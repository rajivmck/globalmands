...
$nodeType =   isset($row->node_type) ? $row->node_type : NULL;
...
$videoLink = isset($row->field_field_file[0]['raw']['uri']) ? $row->field_field_file[0]['raw']['uri'] : NULL;
$videoUrlLink = file_create_url($videoLink);
$parseVideo = parse_url($videoUrlLink,PHP_URL_PATH);

$fileUpload =isset($row->field_field_file_upload[0]['raw']['uri']) ? $row->field_field_file_upload[0]['raw']['uri'] : NULL;
$fileLink = file_create_url($fileUpload);
$fileUploadURL = parse_url($fileLink,PHP_URL_PATH);



?>

<div class="col-lg-4 col-md-6 col-sm-12 shirley">
	<div class="white-box">
		...
		<div class="field-content doc-title">
			<?php if ($nodeType == "video"): ?> 
				<a href="<?php print $parseVideo;?>" class="video-popup"><?php print $title;?></a>
			<?php elseif ($nodeType == "lop_toolkit"): ?> 
				<a href="<?php print $fileUploadURL;?>"><?php print $title;?></a>
			<?php else: ?> 
				<a href="<?php print $root;?>/<?php print $nodeURL;?>" class="video-popup"><?php print $title;?></a>
			<?php endif; ?>   
