...
<div class="section-inner-wrapper">
  <div>
     <?php
              $blockObject = block_load('views', 'resources-block_2');
 ...
 <div id="message-home-popup" class="white-popup mfp-hide">
      To use any of these references please contact the respective team. <br>
      <button title="Close (Esc)" type="button" class="blue-btn" id="close">Close</button>
  </div>
</section>
