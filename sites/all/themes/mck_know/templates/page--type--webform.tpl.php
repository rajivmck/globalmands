  ...
  <div class="section-wrapper case">
    ...
    <section class="full-text-section case-box section-inner-wrapper">
      <div class="page-wrapper">
        <div class="row">
          <div class="col-12 content left-sidebar">
...
<!-- <div id="home-video-popup" class=”white-popup mfp-hide open”>
<a href="http://globalmands.intranet.mckinsey.com/sites/default/files/global_1.mp4" class="video-popup"></a>
</div> -->

 <!-- <div id="popup-video">
      <video id="video-content" width="600" height="400" controls="controls" autoplay="autoplay">
        <source src="http://globalmands.intranet.mckinsey.com/sites/default/files/global_1.mp4" type="video/mp4">
      </video>
    </div>
 -->
