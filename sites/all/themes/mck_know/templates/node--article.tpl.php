...
<div class="page-class popup-wrapper blue">
  ...
  <div class="popup-content">
      ...
      <?php elseif ($docType == 'file'): ?>
 
           <div class="pdf-wrapper pdf3 shirley">                      
             <iframe src="<?php print $base_url;?>sites/all/themes/mck_know/javascript/ViewerJS/#<?php print $base_path; ?>sites/default/files/<?php print $pdfreplace;?> "></iframe>          
          </div>
