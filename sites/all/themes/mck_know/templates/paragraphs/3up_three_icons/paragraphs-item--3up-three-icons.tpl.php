...
<div class="section-wrapper three-up-wrapper <?php echo $wrapperBgColor; ?>">
<a name="<?php echo render($content['field_anchor_name']['#items'][0]['value']) ?>" ></a>
  <section id="three-up" class="up three-up section-inner-wrapper">
      <div class=" universal-header-wrapper text-lg">
        ...
        <div class=" universal-header-wrapper text-lg sub-header">
         <header class="universal-header -rule" data-module="UniversalHeader" >
              <div class="text-wrapper">
                       <h1 class="headline">Other examples of our impact</h1>
               </div>
         </header>
       </div>
    <div class="block-list text-s icon-list">
