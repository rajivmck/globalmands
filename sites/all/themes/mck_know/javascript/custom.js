(function ($) {
  Drupal.behaviors.globalmands = {
    ...
    $("#search").on("submit", function(e){
      ...
      $(this).attr('action', Drupal.settings.basePath + "search/node/" + search_term);

      });
     $( "header .search-nav-submit" ).click(function() {
      var search_term = $("#search input").val();
     //var test=  $(this).attr('action', Drupal.settings.basePath + "search/node/" + search_term);
     var test=  "search/node/" + search_term;
